...
bool                 CJSON_Object_set        (struct CJSON_Object*, struct CJSON_Parser*, const char *key, const struct CJSON*);
...
bool                 CJSON_Object_set_string (struct CJSON_Object*, struct CJSON_Parser*, const char *key, const char*);
bool                 CJSON_Object_set_float64(struct CJSON_Object*, struct CJSON_Parser*, const char *key, double);
bool                 CJSON_Object_set_int64  (struct CJSON_Object*, struct CJSON_Parser*, const char *key, int64_t);
bool                 CJSON_Object_set_uint64 (struct CJSON_Object*, struct CJSON_Parser*, const char *key, uint64_t);
bool                 CJSON_Object_set_object (struct CJSON_Object*, struct CJSON_Parser*, const char *key, const struct CJSON_Object*);
